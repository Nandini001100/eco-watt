  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-background to-muted p-4">
      <div className="w-full max-w-md mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold">Join EcoSmart Insight Hub</h1>
        <p className="mt-2 text-muted-foreground">Create your account to start tracking your energy usage</p>
      </div>
